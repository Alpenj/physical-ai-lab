...
| 이동과 양팔 조작을 결합하는 팀 프로젝트 | [Visual SLAM 기반 이동형 양팔 로봇](projects/mobile-dual-arm/README.md) — 개인 담당 범위·팀원 SLAM 코드·통합 목표를 구분 |
...
## 팀 프로젝트 — Visual SLAM과 양팔 조작

Visual SLAM으로 위치를 파악하는 이동 플랫폼에 양팔을 올려 작업을 수행하는 것이 팀 프로젝트의 목표입니다. 전형주의 양팔 태스크·데이터·정책 실험과 팀원 `shouttt1320`의 SLAM·이동 플랫폼 작업을 구분하고, 두 모듈 사이의 통합 과제를 함께 설명합니다.

[팀 프로젝트 전체 구조와 역할 분담](projects/mobile-dual-arm/README.md) · [팀원 SLAM 공개 저장소](https://github.com/shouttt1320/Dapier_project_visaul_slam)

팀원 코드를 개인의 독자 구현으로 표시하지 않으며, 모듈별 코드 확인과 전체 실물 태스크 성공을 같은 상태로 기록하지 않습니다.
...
| [`projects/mobile-dual-arm/`](projects/mobile-dual-arm/README.md) | 이동형 양팔 팀 프로젝트의 목표·역할·소스 근거·통합 과제 |
...
문서·목록 점검: 2026-09-05. 팀 프로젝트 구조·팀원 소스 안내 추가: 2026-09-07. 학습 글의 내용 확인과 프로그램·실물의 실행 검증은 별도입니다.
